...
class RdsSlowlogWithSdkInputTest < Test::Unit::TestCase
  ...
  CONFIG = %[
    ...
    aws_rds_access_key_id      access_key
    aws_rds_secret_access_key  secret_key
    ...
    aws_sns_access_key_id      access_key
    aws_sns_secret_access_key  secret_key
    aws_sns_region             ap-northeast-1
    aws_sns_topic_arn          arn:aws:sns:ap-northeast-1:xx
  ]
  ...
  def test_configure
    ...
    assert_equal 'access_key',                    d.instance.aws_rds_access_key_id
    assert_equal 'secret_key',                    d.instance.aws_rds_secret_access_key
    ...
    assert_equal 'some_project',                  d.instance.prefix
    ...
    assert_equal 'access_key',                    d.instance.aws_sns_access_key_id
    assert_equal 'secret_key',                    d.instance.aws_sns_secret_access_key
    assert_equal 'ap-northeast-1',                d.instance.aws_sns_region
    assert_equal 'arn:aws:sns:ap-northeast-1:xx', d.instance.aws_sns_topic_arn
  end
